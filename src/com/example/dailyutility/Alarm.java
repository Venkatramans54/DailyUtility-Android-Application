...
public class Alarm implements Comparable<Alarm>
{
  ...
  {
    intent.putExtra("com.example.travelon.id", mId);
    intent.putExtra("com.example.travelon.title", mTitle);
    intent.putExtra("com.example.travelon.date", mDate);
    intent.putExtra("com.example.travelon.alarm", mEnabled);
    intent.putExtra("com.example.travelon.occurence", mOccurence);
    intent.putExtra("com.example.travelon.days", mDays);
  }

  public void fromIntent(Intent intent)
  {
    mId = intent.getLongExtra("com.example.travelon.id", 0);
    mTitle = intent.getStringExtra("com.example.travelon.title");
    mDate = intent.getLongExtra("com.example.travelon.date", 0);
    mEnabled = intent.getBooleanExtra("com.example.travelon.alarm", true);
    mOccurence = intent.getIntExtra("com.example.travelon.occurence", 0);
    mDays = intent.getIntExtra("com.example.travelon.days", 0);
    update();
  }
